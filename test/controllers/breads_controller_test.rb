...
class BreadsControllerTest < ActionController::TestCase
  ...
  test "should create bread" do
    assert_difference('Bread.count') do
      post :create, bread: { description: @bread.description, name: @bread.name, thickness_in_inches: @bread.thickness_in_inches, upcharge: @bread.upcharge }
    end
  ...
  test "should update bread" do
    patch :update, id: @bread, bread: { description: @bread.description, name: @bread.name, thickness_in_inches: @bread.thickness_in_inches, upcharge: @bread.upcharge }
    assert_redirected_to bread_path(assigns(:bread))
  end
